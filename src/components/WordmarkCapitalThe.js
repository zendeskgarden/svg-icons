...
function SvgWordmarkCapitalThe(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 39 26" {...props}>
      <path
        fill="currentColor"
...
export default SvgWordmarkCapitalThe;
